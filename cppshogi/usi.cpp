...
void OptionsMap::init(Searcher* s) {
    ...
    (*this)["OwnBook"]                     = USIOption(true);//★変更した
    (*this)["Min_Book_Score"]              = USIOption(-500, -ScoreInfinite, ScoreInfinite);
    (*this)["USI_Ponder"]                  = USIOption(false);
    (*this)["Stochastic_Ponder"]           = USIOption(true);
    (*this)["Byoyomi_Margin"]              = USIOption(1000, 0, INT_MAX);//★変更した
    ...
    (*this)["DNN_Model"]                   = USIOption(R"(D:\Shogi\TMOQ_denryu_tsec\model\model_66_3.onnx)");//★変更した
    ...
    (*this)["DNN_Batch_Size"]              = USIOption(256, 1, 256);//★変更した
    ...
    (*this)["Resign_Threshold"]            = USIOption(0, 0, 1000);//★変更した
    (*this)["Draw_Value_Black"]            = USIOption(50, 0, 1000);//★変更した
    (*this)["Draw_Value_White"]            = USIOption(50, 0, 1000);//★変更した
...
#else
    (*this)["Engine_Name"]                 = USIOption("TMOQ Debug");
#endif
}
